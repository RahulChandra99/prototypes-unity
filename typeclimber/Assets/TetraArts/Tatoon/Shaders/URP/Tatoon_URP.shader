...
Shader "TetraArts/Tatoon/URP/Tatoon_URP"
{
	Properties
	{
		...
		[ASEEnd][Toggle]_UseOutline("UseOutline", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float2 uv_TextureDiffuse108 = v.ase_texcoord.xy;
				float4 tex2DNode108 = tex2Dlod( _TextureDiffuse, float4( uv_TextureDiffuse108, 0, 0.0) );
				float Alpha111 = tex2DNode108.a;
				float3 unityObjectToViewPos509 = TransformWorldToView( TransformObjectToWorld( v.vertex.xyz) );
				...
				#endif
				float3 vertexValue = ( v.ase_normal * (( _UseOutline )?( _OutlineSize ):( 0.0 )) * Alpha111 * max( unityObjectToViewPos509.z , 0.01 ) );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color110 = ( ( Ambient181 + (( _UseGradient )?( lerpResult102 ):( ( _MainLightColor * _DiffuseColor ) )) ) * tex2DNode108 );
				...
				float2 temp_cast_9 = (_RimTextureTiling).xx;
				float2 texCoord193 = IN.ase_texcoord7.xy * temp_cast_9 + float2( 0,0 );
				...
				float4 Rim185 = (( _UseRim )?( ( saturate( ( NdotL175 * pow( ( 1.0 - saturate( ( dotResult38 + _RimSize ) ) ) , _RimBlend ) ) ) * ( (( _RimLightColor )?( ( ( _RimLightIntensity * _MainLightColor ) + float4( localAdditionalLightsLambert5_g3 , 0.0 ) ) ):( _RimColor )) * tex2D( _RimTexture, rotator198 ) ) ) ):( float4( 0,0,0,0 ) ));
				float2 temp_cast_14 = (_SpecularTextureTiling).xx;
				float2 texCoord143 = IN.ase_texcoord7.xy * temp_cast_14 + float2( 0,0 );
				...
				float4 Specular174 = (( _UseSpecular )?( ( ( ( ( 1.0 - tex2D( _SpecularMap, rotator156 ) ) * (( _SpecLightColor )?( ( ( _MainLightColor * _SpecularLightIntensity ) + float4( localAdditionalLightsLambert5_g4 , 0.0 ) ) ):( _SpecularColor )) ) * smoothstepResult169 ) * NdotL175 ) ):( float4( 0,0,0,0 ) ));
				float4 Result135 = ( ( ( ShadowColor80 * Color110 ) * ( 1.0 - smoothstepResult58 ) ) + ( Color110 * smoothstepResult58 ) + ( Rim185 * Atten328 ) + ( Atten328 * Specular174 ) );
				...
				float4 MainTexture532 = tex2DNode108;
				float4 AdditionalLights541 = ( float4( localAdditionalLightsLambert5_g2 , 0.0 ) * MainTexture532 );
				
				float3 Albedo = color426.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( Result135 + NormalMap132 + AdditionalLights541 ).rgb;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 localAdditionalLightsLambert5_g3 = AdditionalLightsLambert( WorldPosition5_g3 , WorldNormal5_g3 );
				float2 temp_cast_9 = (_RimTextureTiling).xx;
				float2 texCoord193 = IN.ase_texcoord2.xy * temp_cast_9 + float2( 0,0 );
				float cos198 = cos( radians( _RimTextureRotation ) );
				float sin198 = sin( radians( _RimTextureRotation ) );
				...
				float4 Rim185 = (( _UseRim )?( ( saturate( ( NdotL175 * pow( ( 1.0 - saturate( ( dotResult38 + _RimSize ) ) ) , _RimBlend ) ) ) * ( (( _RimLightColor )?( ( ( _RimLightIntensity * _MainLightColor ) + float4( localAdditionalLightsLambert5_g3 , 0.0 ) ) ):( _RimColor )) * tex2D( _RimTexture, rotator198 ) ) ) ):( float4( 0,0,0,0 ) ));
				float2 temp_cast_14 = (_SpecularTextureTiling).xx;
				float2 texCoord143 = IN.ase_texcoord2.xy * temp_cast_14 + float2( 0,0 );
				float cos156 = cos( radians( _SpecularTextureRotation ) );
				float sin156 = sin( radians( _SpecularTextureRotation ) );
...
/*ASEBEGIN
Version=18707
523;327;1205;571;5611.824;837.2734;2.781262;True;False
Node;AmplifyShaderEditor.CommentaryNode;136;-5993.825,-533.1808;Inherit;False;3301.643;968.2485;Specular;41;174;173;172;171;170;169;168;167;166;165;164;163;162;161;160;159;158;157;156;155;154;153;152;151;150;149;148;147;146;145;144;143;142;141;140;139;138;137;555;556;557;Specular;0,1,0.07320952,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;50;-6021.98,1711.117;Inherit;False;2649.39;1146.548;;37;185;202;203;199;200;195;190;34;28;33;201;189;198;197;196;194;193;192;191;24;32;47;31;30;29;177;27;25;38;36;37;204;205;206;553;552;554;Rim;1,0.6396222,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;88;-5994.515,-1665.921;Inherit;False;2909.998;819.7475;Albedo And Gradient;26;111;110;109;108;106;105;104;103;102;101;100;99;98;97;96;95;94;93;92;91;90;89;397;398;409;532;MainColor & Gradient;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;48;-2875.871,3799.353;Inherit;False;921.8123;481.9126;Comment;4;175;3;2;1;N . L;1,0.9979696,0,1;0;0
Node;AmplifyShaderEditor.WorldNormalVector;1;-2858.867,3849.615;Inherit;False;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;2;-2857.138,4120.167;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldNormalVector;556;-4175.476,155.0919;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.DotProductOpNode;3;-2504.845,3947.326;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;554;-5006.618,2350.378;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.FunctionNode;555;-3955.277,157.5332;Inherit;False;SRP Additional Light;-1;;4;6c86746ad131a0a408ca599df5f40861;3,6,1,9,1,23,0;5;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;1,1,1;False;18;FLOAT;0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;163;-4180.132,-203.0268;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.IndirectDiffuseLighting;11;-2905.795,3083.836;Inherit;False;Tangent;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;557;-4048.01,-191.9122;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-2336.257,2955.615;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RadiansOpNode;68;-5078.873,1292.965;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;552;-4679.784,2413.364;Inherit;False;SRP Additional Light;-1;;3;6c86746ad131a0a408ca599df5f40861;3,6,1,9,1,23,0;5;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;1,1,1;False;18;FLOAT;0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;204;-4618.917,2272.274;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;175;-2208.302,3937.432;Inherit;True;NdotL;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightColorNode;105;-4585.945,-1566.099;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;409;-4295.054,-1475.091;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.AbsOpNode;479;-2601.883,3212.864;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;553;-4453.908,2271.337;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;181;-1969.304,2953.191;Inherit;False;Ambient;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;73;-4571.643,860.2289;Inherit;False;Property;_ShadowColor;Shadow Color;8;0;Create;True;0;0;False;0;False;1,0,0,1;0.5377358,0.5377358,0.5377358,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;106;-4061.366,-1289.033;Inherit;False;Property;_UseGradient;Use Gradient;17;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;398;-3768.899,-1310.887;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;-4196.302,2210.604;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;328;-1976.064,3216.67;Inherit;True;Atten;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;32;-4313.722,1880.201;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;187;-2888.299,1512.832;Inherit;False;2670.171;1108.631;Comment;20;135;221;406;42;86;408;82;176;405;83;186;112;58;81;57;476;55;56;331;184;Mix;0,0.3468349,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;202;-3932.682,2009.46;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-2838.299,1974.783;Inherit;False;Property;_ShadowSize;Shadow Size;9;0;Create;True;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;405;-1483.805,2218.732;Inherit;False;328;Atten;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;186;-1242.855,2138.069;Inherit;False;185;Rim;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;135;-466.8953,1916.355;Inherit;True;Result;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;549;-1279.096,3367.441;Inherit;False;1045.903;268.7461;Comment;5;533;516;534;540;541;AdditionalLights;1,0.903612,0,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;532;-3715.719,-1081.612;Inherit;False;MainTexture;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldNormalVector;540;-1229.096,3417.492;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;533;-956.5528,3520.187;Inherit;False;532;MainTexture;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;516;-974.7518,3417.441;Inherit;False;SRP Additional Light;-1;;2;6c86746ad131a0a408ca599df5f40861;3,6,1,9,1,23,0;5;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;1,1,1;False;18;FLOAT;0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;534;-717.2822,3418.952;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;541;-465.1935,3480.843;Inherit;False;AdditionalLights;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;188;519.1929,1400.734;Inherit;False;882.6021;696.9648;Comment;5;134;426;133;180;544;Master;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;542;593.6743,1928.328;Inherit;False;541;AdditionalLights;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;133;605.3237,1810.39;Inherit;False;132;NormalMap;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;538;-1734.365,295.5476;Inherit;False;1354.026;699.9822;Comment;11;511;512;501;497;498;508;500;509;513;499;543;Outline;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;180;618.0904,1710.963;Inherit;False;135;Result;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;499;-1016.249,345.5476;Inherit;False;Property;_OutlineColor;OutlineColor;42;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NormalVertexDataNode;500;-1386.86,409.0043;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;501;-1390.518,633.1157;Inherit;False;111;Alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;513;-1218.345,543.5552;Inherit;False;Property;_UseOutline;UseOutline;43;0;Create;True;0;0;False;0;False;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;426;794.2895,1444.609;Inherit;False;Constant;_Color0;Color 0;53;0;Create;True;0;0;False;0;False;0,0,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;498;-1552.206,561.2153;Inherit;False;Property;_OutlineSize;OutlineSize;41;0;Create;True;0;0;False;0;False;0.3;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;512;-1154.228,729.1016;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;508;-1684.365,717.0131;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;511;-1444.962,879.5297;Inherit;False;Constant;_Float2;Float 2;41;0;Create;True;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.UnityObjToViewPosHlpNode;509;-1466.807,716.7913;Inherit;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleAddOpNode;134;897.1874,1784.464;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;497;-945.7715,535.1959;Inherit;False;4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;546;1160.151,1646.06;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;11;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;548;1160.151,1646.06;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;11;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;544;1074.395,1587.102;Float;False;True;-1;2;TatoonEditorURP;0;2;TetraArts/Tatoon/URP/Tatoon_URP;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;1;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;1;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;True;True;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;547;1160.151,1646.06;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;11;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;543;-726.4922,520.506;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;OutlinePass;5;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;2;5;False;-1;10;False;-1;5;4;False;-1;1;False;-1;False;False;False;False;False;False;False;False;True;1;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;5;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;545;1160.151,1646.06;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;11;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;557;0;163;0
WireConnection;557;1;555;0
WireConnection;10;0;8;0
WireConnection;10;1;11;0
WireConnection;68;0;67;0
WireConnection;552;11;554;0
...
WireConnection;532;0;108;0
WireConnection;130;0;127;0
WireConnection;130;1;126;0
WireConnection;129;0;128;0
WireConnection;129;1;125;0
WireConnection;516;11;540;0
WireConnection;534;0;516;0
WireConnection;534;1;533;0
WireConnection;131;0;129;0
WireConnection;131;1;130;0
WireConnection;541;0;534;0
WireConnection;132;0;131;0
WireConnection;513;1;498;0
WireConnection;111;0;108;4
WireConnection;512;0;509;3
WireConnection;512;1;511;0
WireConnection;509;0;508;0
WireConnection;134;0;180;0
WireConnection;134;1;133;0
WireConnection;134;2;542;0
WireConnection;497;0;500;0
WireConnection;497;1;513;0
WireConnection;497;2;501;0
WireConnection;497;3;512;0
WireConnection;544;0;426;0
WireConnection;544;2;134;0
WireConnection;544;3;426;0
WireConnection;544;4;426;0
WireConnection;543;0;499;0
WireConnection;543;3;497;0
ASEEND*/
//CHKSM=0BDDFE2F8BBDAA2F0FC16AA47F7F5971DA1B49BA